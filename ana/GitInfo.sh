...
echo "#define GIT_BRANCH        \" $( git branch --remote --no-abbrev --contains) \"" >> ${OUTPUT_PATH}/GitInfo.h
echo "#define GIT_DIFF_SHORT_STAT \" $( git branch --no-abbrev --contains) : $( git diff --shortstat) \"" >> ${OUTPUT_PATH}/GitInfo.h
