...
void lukas() {
    ...
    basic1->LoadData();
    TFile * treefile = TFile::Open("basic1.root", "RECREATE");
    TTree * tree = new TTree("test", "test");
    tree -> Branch("testcanv","testcanv",basic1,32000,0);
    tree -> Fill();
    tree -> Write();
    treefile -> Close();
    ...
    tree0 -> Branch("testcanv0","testcanv0",basic2,32000,0);
    tree0 -> Fill();
    tree0 -> Write();
    treefile0 -> Close();
    ...
    tree1 -> Branch("testcanv1","testcanv1",&basiccopy,32000,0);
    tree1 -> Fill();
    tree1 -> Write();
    treefile1 -> Close();
    ...
    tree2 -> Branch("testcanv2","testcanv2",&basicassign,32000,0);
    tree2 -> Fill();
    tree2 -> Write();
    treefile2 -> Close();
    ...
    tree3 -> Branch("testcanv3","testcanv3",&basiccopyaddit,32000,0);
    tree3 -> Fill();
    tree3 -> Write();
    treefile3 -> Close();
    ...
    tree4 -> Branch("testcanv4","testcanv4",&basicassignaddit,32000,0);
    tree4 -> Fill();
    tree4 -> Write();
    treefile4 -> Close();
