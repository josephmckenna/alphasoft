...
Double_t MatchEventToTime(Int_t runNumber,TString description, TString name, Int_t repetition=1, Int_t offset=0);//, Bool_t ExactMatch=true);
Double_t MatchEventToTime(Int_t runNumber,TString description, Bool_t IsStart, Int_t repetition=1, Int_t offset=0);//, Bool_t ExactMatch)
#endif
