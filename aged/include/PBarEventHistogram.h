...
//==============================================================================
#ifndef __PBarEventHistogram_h__
#define __PBarEventHistogram_h__

#include "PHistImage.h"

struct ImageData;

class PBarEventHistogram : public PHistImage {
public:
    PBarEventHistogram(PImageWindow *owner, Widget canvas=0);
    virtual ~PBarEventHistogram();
