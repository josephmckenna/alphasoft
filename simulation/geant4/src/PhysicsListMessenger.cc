...
PhysicsListMessenger::PhysicsListMessenger(PhysicsList* pPhys): pPhysicsList(pPhys) 
{
  ...
  gammaCutCmd = new G4UIcmdWithADoubleAndUnit("/AGTPC/phys/setGCut", this);
  ...
  electCutCmd = new G4UIcmdWithADoubleAndUnit("/AGTPC/phys/setECut", this);
  ...
  protoCutCmd = new G4UIcmdWithADoubleAndUnit("/AGTPC/phys/setPCut", this);
  ...
  allCutCmd = new G4UIcmdWithADoubleAndUnit("/AGTPC/phys/setCuts", this);
  ...
  pListCmd = new G4UIcmdWithAString("/AGTPC/phys/InitializePhysics", this);
  ...
  addParamCmd = new G4UIcmdWithoutParameter("/AGTPC/phys/AddParametrisation", this);
  addParamCmd->SetGuidance("Add the parametrisation");
  addParamCmd->AvailableForStates(G4State_PreInit);

  lowLimitECmd = new G4UIcmdWithADoubleAndUnit("/AGTPC/phys/setLowLimitE", this);
