...
#protoTOF.exe -O$DATADIR/gareth/tofrun904528.root --mt $MIDASDATA/run904528sub000.mid.lz4 -- --bscprint &> RunLogs/R904528.log & 
protoTOF.exe -O$DATADIR/gareth/tofrun904542.root --mt $MIDASDATA/run904542sub000.mid.lz4 -- --bscprint --bscpulser --bscoffsetfile bscoffsets5.calib &> RunLogs/R904542.log & 
