...
public:
   ...
   void AddSpacePoint( const std::vector< std::pair<ALPHAg::signal,ALPHAg::signal> > spacepoints );
   void AddSpacePoint( const std::vector< std::pair<ALPHAg::signal,ALPHAg::signal> > spacepoints, const double zcut );
