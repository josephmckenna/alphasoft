...
void Match::CentreOfGravity_histoblobs( std::vector<ALPHAg::signal> &vsig, std::vector<ALPHAg::signal>* CombinedPads )
{
...
void Match::CentreOfGravity_nofit( std::vector<ALPHAg::signal> &vsig, std::vector<ALPHAg::signal>* CombinedPads  )
{
  if(!vsig.size()) return;
  double time = vsig.begin()->t;
  short col = vsig.begin()->sec;
...
void Match::CentreOfGravity_single_peak( std::vector<ALPHAg::signal> &vsig, std::vector<ALPHAg::signal>* CombinedPads )
{
  if(!vsig.size()) return;
...
void Match::CentreOfGravity_multi_peak( std::vector<ALPHAg::signal> &vsig, std::vector<ALPHAg::signal>* CombinedPads )
{
...
void Match::CentreOfGravity_nohisto( std::vector<ALPHAg::signal> &vsig, std::vector<ALPHAg::signal>* CombinedPads )
{
  if(!vsig.size()) return;
  double time = vsig.begin()->t;
  short col = vsig.begin()->sec;
