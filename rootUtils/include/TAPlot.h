...
class TAPlot: public TObject
{
   protected:
      ...
      std::vector<TAPlotFEGEMData> fFEGEM;
      std::vector<TAPlotFELabVIEWData> fFELV;

      TAPlotTimeWindows fTimeWindows;
      TAPlotVertexEvents fVertexEvents;
   ...
   public:
      ...
      std::vector<TAPlotFELabVIEWData> GetLVData()       {  return fFELV; }
      ...
      void LoadFELVData(int runNumber, TAPlotFELabVIEWData& labviewData, TTreeReader* labviewReader, const char* name, double firstTime, double lastTime);
