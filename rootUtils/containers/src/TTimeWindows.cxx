...
ClassImp(TTimeWindows)

TTimeWindows::TTimeWindows()
{
...
//Copy ctor
TTimeWindows::TTimeWindows(const TTimeWindows& timeWindows) : TObject(timeWindows)
{
...
TTimeWindows& TTimeWindows::operator=(const TTimeWindows& rhs)
{
...
TTimeWindows operator+(const TTimeWindows& lhs, const TTimeWindows& rhs)
{
...
void TTimeWindows::AddTimeWindow(int runNumber, double minTime, double maxTime, double timeZero)
{
...
int TTimeWindows::GetValidWindowNumber(double time)
{
...
void TTimeWindows::SortTimeWindows()
{
...
std::string TTimeWindows::CSVTitleLine() const
{
...
std::string TTimeWindows::CSVLine(size_t i) const
{
   //This is a little fugly
   return std::to_string(fRunNumber.at(i)) + "," +
   std::to_string(fMinTime.at(i)) + "," +
   std::to_string(fMaxTime.at(i)) + "," +
   std::to_string(fZeroTime.at(i));
}

size_t TTimeWindows::size() const
{
